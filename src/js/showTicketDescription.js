function collapseTicketDescription(e) {
  const targetTicket = e.target.closest('.ticket');
  const ticketDescription = targetTicket.querySelector('.ticket-description');
...
export function showTicketDescription() {
    ...
    ticketsArray.forEach(ticket => ticket.addEventListener('click', (e) => collapseTicketDescription(e)));
  }